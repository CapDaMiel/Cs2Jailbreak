...
namespace Katrox
{
    public partial class Katrox
    {
        ...
        public static readonly CounterStrikeSharp.API.Modules.Utils.Vector VEC_ZERO = CounterStrikeSharp.API.Modules.Utils.Vector.Zero;
    ...
    public class RayTrace
    {
        ...
        public static unsafe GameTrace? TraceShape(CSVector? origin, QAngle angles, ulong mask)
        {
            ...
            {
                _Logger?.LogError("TraceFunc or GameTraceManager is 0");
                return null;
            }
